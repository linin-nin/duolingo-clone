...
const QuestionBubble = ({ question}:Props) => {
  return (
    <div className='flex items-center gap-x-4 mb-6'>
        <Image src="/images/cow.png" alt='Cow' height={40} width={40} className='hidden lg:block'/>
        <Image src="/images/cow.png" alt='Cow' height={40} width={40} className='block lg:hidden'/>
